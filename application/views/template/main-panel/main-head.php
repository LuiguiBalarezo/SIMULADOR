...
<html>
  <head>
    ...
    <!-- Icon Page -->
    <link rel="shortcut icon" href="<?php echo PATH_RESOURCE_ADMIN; ?>img/icon/servosa.png" type="image/png">
    <!-- Bootstrap 3.3.5 -->
...
<!--    <link rel="stylesheet" href="--><?php //echo PATH_RESOURCE_PLUGINS; ?><!--datetimepicker/bootstrap-datetimepicker.min.css">-->
    <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
          page. However, you can choose any other skin. Make sure you
          apply the skin class to the body tag so the changes take effect. -->
    <link rel="stylesheet" href="<?php echo PATH_RESOURCE_DIST; ?>css/skins/skin-blue.css">
    <!-- My Theme style -->
