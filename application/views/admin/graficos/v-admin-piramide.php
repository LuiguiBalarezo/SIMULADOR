          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-success">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <button id="btn_nacional" class="btn btn-primary">PIRAMIDE NACIONAL</button>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <button id="btn_regional" class="btn btn-primary" data-toggle="modal" data-target="#m_region">PIRAMIDE REGIONAL</button>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <button id="btn_operacion" class="btn btn-primary" data-toggle="modal" data-target="#m_operacion">PIRAMIDE POR OPERACION</button>
                        </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div id="piramide" class="col-md-12" style="visibility: hidden">
                      <div id="trapezoid1"><p id="value1" class="letter"></p></div>
                      <div id="trapezoid2"><p id="value2" class="letter"></p></div>
                      <div id="trapezoid3"><p id="value3" class="letter"></p></div>
                      <div id="trapezoid4"><p id="value4" class="letter"></p></div>
                      <div id="trapezoid5"><p id="value5" class="letter"></p></div>
<!--                      <small class="pull-right"><button class="btn btn-primary"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Exportar</button></small>-->
                    </div>
                  </div>
                  <br/><br>
                  <div id="leyend" class="col-md-12" style="margin-top: 20px; visibility: hidden">
                    <div class="col-md-12">
                      <div class="col-md-4"></div>
                      <div class="col-md-4 col-sm-12">
                        <div><div id="leyend1"></div><div class="textleyend">Muerte / Incapacitantes </div></div>
                        <div><div id="leyend2"></div><div class="textleyend">Accidentes Daños Personales </div></div>
                        <div><div id="leyend3"></div><div class="textleyend">Accidentes Daños Propiedad </div></div>
                        <div><div id="leyend4"></div><div class="textleyend">Casi Accidentes </div></div>
                        <div><div id="leyend5"></div><div class="textleyend">Comportamiento de Riesgo / Condiciones Inseguras </div></div>
                      </div>
                      <div class="col-md-4 col-sm-12">
                      </div>
                    </div>
                    <div class="col-md-12" style="margin-top: 20px; ">
                      ...
                      <div class="col-md-4 col-sm-12" style="display: flex; justify-content: center;">
                          <a class="info-box-icon exportar"><i class="fa botonimagen"></i></a>

                      </div>
                      <form id="datos" name="datos" action="<?php echo base_url()."admin/excelP"; ?>" method="post" hidden  >
...
<!--    <script src="https://code.highcharts.com/modules/exporting.js"></script>-->
    ...
    <script>
      ...
      $("#btn_nacional").on("click", function(evt){
        ...
        $("#piramide").css("visibility", "hidden");
        ...
        if(id_tipo_usuario == 2 ){
          ...
          var request = $.ajax({
            url: baseUrl + "api-rest/evento/getEventosPiramide",
            method: "POST",
            data: formData,
            dataType: "json",
            processData: false,
          ...
          request.done(function( response ) {
            ...
            if (response.status) {
              ...
              swal("Piramide de Brid", response.message, "success");
              $("#value1").html(response.data.piramide_nivel_1);
              $("#value2").html(response.data.piramide_nivel_2);
              $("#value3").html(response.data.piramide_nivel_3);
              $("#value4").html(response.data.piramide_nivel_4);
              $("#value5").html(response.data.piramide_nivel_5);

              $("#btn_nacional").css("background", "#7bb51e");
              $("#btn_regional").css("background", "#367fa9");
              $("#btn_operacion").css("background", "#367fa9");

              $("#piramide").css("visibility", "visible");
              $("#leyend").css("visibility", "visible");
              $( ".exportar" ).css("display", "block");

            } else {
              swal("Piramide de Brid", response.message, "error");
            }
          ...
          request.fail(function( jqXHR, textStatus ) {
            waitingDialog.hide();
            swal("Piramide de Brid", textStatus, "error");

          });

        }else {
          swal("Piramide de Brid", "Usted no puede acceder a esta piramide", "warning");
        }
