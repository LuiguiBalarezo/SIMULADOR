    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            EVENTO <?php echo $modulo->evento->nombre_evento; ?> - <?php echo $modulo->titulo; ?>
            <small>&nbsp;&nbsp; <a href="<?php echo base_url(); ?>admin/evento"><i class="fa fa-reply" aria-hidden="true"></i></a></small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo $modulo->titulo_registro; ?>&nbsp;&nbsp;<a href="<?php echo base_url().$modulo->base_url.$modulo->evento->id_evento; ?>/agregar"><i class="fa fa-plus-square" aria-hidden="true"></i></a></h3>
                </div><!-- /.box-header -->
