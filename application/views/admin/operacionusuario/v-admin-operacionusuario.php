      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>&nbsp;&nbsp; <a href="<?php echo base_url(); ?>admin/usuario"><i class="fa fa-reply" aria-hidden="true"></i></a></small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo $modulo->titulo_registro; ?>&nbsp;&nbsp;<a href="<?php echo base_url().$modulo->base_url.$modulo->usuario->id_usuario; ?>/agregar"><i class="fa fa-plus-square" aria-hidden="true"></i></a></h3>
                </div><!-- /.box-header -->
      ...
      $(function () {
        ...
        $(".btnActionRow").on("click", function(evt){
          ...
          if ( $(this).attr("data-row-action") == "delete") {
            evt.preventDefault();
            formData.append("idUsuario", $(this).attr("data-row-id-user"));
            formData.append("idOperacion", $(this).attr("data-row-id-ope"));

            swal({
                  title: "Eliminar Asignacion",
                  text: "¿Seguro que desea eliminar la Asignacion?",
                  type: "warning",
