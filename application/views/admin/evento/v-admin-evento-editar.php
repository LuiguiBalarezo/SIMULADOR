    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url(); ?>admin/evento">Evento</a> </li>
                                ...
                                <div class="box-body">
                                        ...
                                        <form id="formEmpresa" role="form"  enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php
                                                if ( isset($modulo->idEvento) ) { ?>
                                                    <input type="hidden" name="idEvento" id="idEvento" value="<?php echo $modulo->idEvento; ?>">
                                                <?php }else{ ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <?php
                                                                if (isset($existeEmpresa) && $existeEmpresa ) { ?>
                                                                    <input type="text" value="<?php echo $dataEmpresa->codigo_evento; ?>" class="form-control" id="txtCodigo" name="txtCodigo" maxlength="3" data-parsley-required data-parsley-required-message="Ingrese un Codigo.">
                                                                <?php } else { ?>
                                                                    <input type="text" class="form-control" id="txtCodigo" name="txtCodigo" maxlength="3" data-parsley-required data-parsley-required-message="Ingrese un Codigo.">
                                                                <?php } ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="txtFirstName">Evento</label>
                                                            <?php
                                                            if (isset($existeEmpresa) && $existeEmpresa ) { ?>
                                                                
                                                                <input type="text" class="form-control" id="txtNombre" name="txtNombre" value="<?php echo $dataEmpresa->nombre_evento; ?>" maxlength="150" data-parsley-required data-parsley-required-message="Ingrese el nombre.">
                                                            <?php } else { ?>
...
<script>
    $(function () {
        ...
        var selectorInputsForm = ["#txtNombre", "#txtCodigo"];

        $("#btnAgregar").on("click", function(evt){

            evt.preventDefault();
            var urlApi    = baseUrl + <?php if (isset($modulo->idEvento)) { echo '"editar";'; } else { echo '"crear";'; } ?>;
            ...
            if ( ValidateInputFormWithParsley.validate(selectorInputsForm)) {
                ...
                request.done(function( response ) {
                    ...
                    if (response.status) {
                        ...
                        swal("Evento", response.message, "success");

                    } else {
                        swal("Evento", response.message, "error");
                    }
