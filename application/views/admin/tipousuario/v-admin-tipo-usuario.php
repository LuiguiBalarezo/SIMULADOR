            ...
            <div class="col-xs-12">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo $modulo->titulo_registro; ?> &nbsp;&nbsp;<a href="<?php echo base_url().$modulo->base_url; ?>agregar"><i class="fa fa-plus-square" aria-hidden="true"></i></a></h3>
                </div><!-- /.box-header -->
      ...
      $(function () {
        ...
        $(".btnActionRow").on("click", function(evt){
          ...
          if ( $(this).attr("data-row-action") == "delete") {
            evt.preventDefault();
            formData.append("id_tipo_usuario", $(this).attr("data-row-id"));

            swal({
                  title: "Eliminar Tipo de Usuario",
                  text: "¿Seguro que desea eliminar el Tipo de Usuario?",
                  type: "warning",
