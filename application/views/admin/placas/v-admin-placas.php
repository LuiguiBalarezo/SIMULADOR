    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            OPERACION <?php echo $modulo->operacion->nombre_operacion; ?> - <?php echo $modulo->titulo; ?>
            <small>&nbsp;&nbsp; <a href="<?php echo base_url(); ?>admin/operacion"><i class="fa fa-reply" aria-hidden="true"></i></a></small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo $modulo->titulo_registro; ?>&nbsp;&nbsp;<a href="<?php echo base_url().$modulo->base_url.$modulo->operacion->id_operacion; ?>/agregar"><i class="fa fa-plus-square" aria-hidden="true"></i></a></h3>
                </div><!-- /.box-header -->
      ...
      $(function () {
        ...
        $(".btnActionRow").on("click", function(evt){
          ...
          if ( $(this).attr("data-row-action") == "delete") {
            evt.preventDefault();
            formData.append("id_placa", $(this).attr("data-row-id"));

            swal({
                  title: "Eliminar Operacion",
                  text: "¿Seguro que desea eliminar la Operacion?",
                  type: "warning",
