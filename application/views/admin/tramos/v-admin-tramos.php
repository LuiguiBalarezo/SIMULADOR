    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            OPERACION <?php echo $modulo->operacion->nombre_operacion?> - RUTA <?php echo $modulo->operacion->nombre_ruta?> - <?php echo $modulo->titulo; ?>
            <small>&nbsp;&nbsp; <a href="<?php echo base_url()."admin/rutas/".$modulo->operacion->id_operacion; ?>"><i class="fa fa-reply" aria-hidden="true"></i></a></small>
          </h1>
          <ol class="breadcrumb">
      ...
      $(function () {
        ...
        $(".btnActionRow").on("click", function(evt){
          ...
          if ( $(this).attr("data-row-action") == "delete") {
            evt.preventDefault();
            formData.append("id_tramo", $(this).attr("data-row-id"));

            swal({
                  title: "Eliminar Tramo",
                  text: "¿Seguro que desea eliminar el Tramo?",
                  type: "warning",
